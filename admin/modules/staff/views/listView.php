    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách nhân sự</h3>
                    <a href="?modules=staff&controllers=index&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
                        ...
                        <table class="table list-table-wp">
                            <thead>
                                <tr>
                                    ...
                                    <td><span class="thead-text">Ngày bắt đầu</span></td>>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="tbody-text"><?php echo $value['role']; ?></span></td>
                                    <!-- <td>
